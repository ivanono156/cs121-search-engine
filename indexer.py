...
def _computeWordWeights(tokens_list):
    #Initializing dictionary/map of the tokens and the number of occurances
    word_freq = {}
    #Iterates through all the values in the token list and updates its value in the corresponding dictionary/mapping 
    for token in tokens_list:
        #Checks the value of the token in the dictionary and sets it to the appropiate value either 1 or +1
